...
/** @type {string} */
const CACHE_VERSION = '1790297172|2338723627';
/** @type {string} */
const CACHE_PREFIX = 'Jarvia-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Jarvia.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Jarvia.html","Jarvia.js","Jarvia.offline.html","Jarvia.icon.png","Jarvia.apple-touch-icon.png","Jarvia.audio.worklet.js","Jarvia.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Jarvia.wasm","Jarvia.pck","Jarvia.side.wasm"];
